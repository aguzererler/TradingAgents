...
def create_portfolio_manager(llm, memory):
    def portfolio_manager_node(state) -> dict:
        ...
        is_critical_abort = (
            (market_research_report and "[CRITICAL ABORT]" in market_research_report) or
            (fundamentals_report and "[CRITICAL ABORT]" in fundamentals_report)
        )
        ...
        if is_critical_abort:
            ...
            abort_report = market_research_report if (market_research_report and "[CRITICAL ABORT]" in market_research_report) else fundamentals_report
